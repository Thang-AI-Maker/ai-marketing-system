...
- **Chỉ hỏi nếu ở chế độ nhiều dự án:** lưu ở đâu? Mặc định theo quy ước `4. Mint/Active/[Tên dự án]/` (xem AGENTS.md gốc). Nếu dự án đã có thư mục trong `4. Mint/`, dùng thư mục đó. Có `_MOC [Tên dự án].md` hay note tổng quan dự án nào để link `up:` trong frontmatter không?
...
Cấu trúc body — mỗi khối là 1 heading, đặt tên **tiếng Anh kèm tiếng Việt trong ngoặc** (quy ước AGENTS.md của vault này):
