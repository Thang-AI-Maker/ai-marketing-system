...
```bash
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "KEYWORD" [OPTIONS]
```
...
```bash
# Tìm video về "Codex" nhiều views nhất tháng này
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "Codex"

# Tìm video AI agents, ít nhất 50K views, trong tuần
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "ai agents" --min-views 50000 --date week

# Sắp xếp theo breakout ratio
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "mcp server" --sort ratio

# Video tiếng Việt về AI
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "AI automation" --lang vi --min-views 5000

# Chỉ in ra terminal
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "vibe coding" --no-save
```
...
----|--------------------------------|----------------|----------|----------|-------|---------------------------
 1  | Codex Changed Everything | @TechGuy       | 245,000  | 50,000   | 4.9x  | youtu.be/abc123
 2  | How I Use Codex Daily    | @AIBuilder     | 180,000  | 120,000  | 1.5x  | youtu.be/def456
...
```
...
Slug được tạo từ keyword: `"Codex"` → `Codex`
...
```bash
uv run .Codex/skills/nghien-cuu-video-youtube/scripts/research_topic.py "KEYWORD" --min-views MIN --date DATE --sort SORT
```
